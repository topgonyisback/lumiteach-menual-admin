const manualTree = [
  {
    ...
    "title": "로그인 및 가입 신청",
    "description": "LumiTeach 어드민에 Google 계정으로 로그인하고, 최초 접근 시 관리자 권한을 신청한 뒤 Google OTP 인증을 설정하는 방법입니다.",
    "children": []
  },
  {
...
const articleTemplates = {
  "cat-admin-login-signup": [
    ...
    "로그인 및 가입 신청",
    "LumiTeach 어드민에 Google 계정으로 로그인하고, 최초 접근 시 관리자 권한을 신청한 뒤 Google OTP 인증을 설정하는 방법입니다.",
...
const articleIntros = {
  ...
  "cat-admin-lesson-bulk-upload": "> 레슨 일괄 등록은 엑셀 파일 하나로 여러 개의 레슨과 활동을 한꺼번에 등록하는 기능입니다. 레슨을 하나씩 직접 입력하는 것보다 빠르게 대량의 콘텐츠를 등록할 수 있습니다.",
