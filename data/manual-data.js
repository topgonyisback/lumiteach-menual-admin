...
const articleBodies = {
  "cat-admin-login-signup": [
    ...
    "- LumiTeach 어드민은 보안을 위해 Google OTP 2차 인증을 사용합니다.\n\n### **최초 로그인 시 — OTP 설정** OTP는 최초 로그인 시 1회만 설정하면 됩니다. 이후 로그인 시에는 앱에 표시된 6자리 인증 코드만 입력하면 됩니다.\n\n- 앱스토어 또는 플레이스토어에서 **Google Authenticator** 앱을 설치하세요.🔗 Google Play Store 🔗 Apple App Store\n\n- Google Authenticator 앱을 실행하고, 하단의 `**+** ` 버튼을 탭하세요.\n\n- **[QR코드 스캔]** 을 선택하고, 어드민 로그인 화면에 표시된 QR코드를 스캔하세요.\n\n- 앱에 표시된 6자리 인증 코드를 입력하면 설정이 완료됩니다.\n\n[[image:admin-login-signup/04.png|화면 예시]]\n\n### **이후 로그인 시 — OTP 인증** - Google 계정으로 로그인하세요.\n\n- Google Authenticator 앱을 실행하여 표시된 6자리 인증 코드를 입력하세요.\n\n[[callout:✅||**보안을 위해 아래 사항을 확인해 주세요.**]]"
  ],
  "cat-admin-dashboard": [
